...
ESTRUCTURA : ESTRUCTURA ROOT    { $1.push($2); $$ = $1; addProduccion('ESTRUCTURA -> ESTRUCTURA ROOT', 'ESTRUCTURA.val = ESTRUCTURA.val.push(ROOT.val)'); }
    | ROOT                      { $$ = [$1]; addProduccion('ESTRUCTURA -> ROOT', 'ESTRUCTURA.val = ROOT.val'); }  
    ;
